...
COPY public.alunos_desafios (al_id, de_id, ad_status, ad_progresso) FROM stdin;
2	2	inativo	25
4	5	inativo	25
5	3	inativo	25
1	5	ativo	50
...
COPY public.desafios (de_id, de_nome, de_descricao, de_pontos, de_tag, de_start, de_end, de_status) FROM stdin;
5	Energia Máxima	Participe de uma aula de HIIT sem pausas.	200	hiit	2025-11-10 00:00:00	2025-12-10 00:00:00	ativo
7	Funcional Power	Complete 3 treinos funcionais no mês.	130	funcional	2025-11-01 00:00:00	2025-12-01 00:00:00	ativo
4	Desafio do Core	Complete todos os exercícios abdominais do mês.	150	core	2025-11-10 00:00:00	2025-12-10 00:00:00	ativo
1	Primeiros Passos	Complete seu primeiro treino com sucesso.	50	iniciacao	2025-11-01 00:00:00	2025-12-01 00:00:00	ativo
6	Alongue-se	Faça 500 sessões de alongamento.	2000	flexibilidade	2025-11-03 00:00:00	2025-11-30 00:00:00	Concluído
2	Foco Total	Conclua 5 treinos em uma semana.	120	consistencia	2025-11-01 00:00:00	2025-11-30 00:00:00	Inativo
3	Corpo em Movimento	Participe de 3 turmas diferentes.	100	participacao	2025-11-05 00:00:00	2025-12-05 00:00:00	Ativo
\.
...
3	anthonyld.comp@gmail.com	60fe3cbd79670dc660722d751aeb0849f2f593deabdc369b7aad58728cdc7aa0	2025-11-30 18:57:40.573	1	2025-11-30 17:57:40.574
\.
...
COPY public.resgates (re_id, al_id, pd_id, re_hash, re_preco, re_data, re_status) FROM stdin;
1	1	6	f3fe5b63a1045316	35	2025-11-24 15:10:56.208	resgatado
2	1	8	c0ed0f22b83b785d	10	2025-11-24 22:29:42.236	resgatado
3	1	8	84d5acc2f7b29449	10	2025-11-25 21:32:01.561	resgatado
4	1	8	10406826f73b76c7	10	2025-11-25 21:32:12.431	resgatado
5	1	8	c1603a1fa66cbc2a	10	2025-11-25 21:32:28.634	resgatado
6	1	8	29cdde77e615edd0	10	2025-11-25 21:32:47.788	resgatado
7	1	8	306a47451f516602	10	2025-11-25 21:34:21.51	resgatado
8	1	8	b9b7d2127445de53	10	2025-11-25 21:36:11.056	resgatado
\.
...
SELECT pg_catalog.setval('public.alunos_al_id_seq', 8, true);
...
SELECT pg_catalog.setval('public.funcionarios_fu_id_seq', 14, true);
...
SELECT pg_catalog.setval('public.password_reset_pr_id_seq', 3, true);
