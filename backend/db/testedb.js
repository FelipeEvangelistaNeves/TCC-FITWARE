...
const Aluno = require("../models/alunos")(sequelize, DataTypes);
const Funcionario = require("../models/funcionarios")(sequelize, DataTypes);
...
(async () => {
  try {
    ...
    const fitwareTeste = "carlos@fitware.com";
