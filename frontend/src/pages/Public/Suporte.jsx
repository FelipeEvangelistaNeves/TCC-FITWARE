      ...
      <div className="suporte-container">
        ...
        <section className="suporte-sections container">
          <div className="suporte-card">
            ...
            <p>
              Acesse nossa base de conhecimento e encontre respostas rápidas
        ...
        <section className="suporte-faq container">
          ...
          <div className="faq-item">
            ...
            <p>
              Vá até a página de login, clique em "Esqueci minha senha" e siga
              as instruções enviadas por e-mail.
            </p>
          </div>
          ...
          <div className="faq-item">
            ...
            <p>
              Acesse o painel do usuário, vá até "Planos" e selecione o novo
              plano desejado.
            </p>
          </div>
          ...
          <div className="faq-item">
            ...
            <p>
              Sim! Oferecemos uma aula gratuita para novos alunos. É só
